...
class MerchantView(discord.ui.View):
    ...
    async def buy_health_potion(self, interaction: discord.Interaction):
    ...
    async def buy_magic_potion(self, interaction: discord.Interaction):
    ...
    async def stop_shopping(self, interaction: discord.Interaction):
