    ...
    class rpg():
        ...
        class item_use():
            def use(interaction: discord.Interaction,item:str):
                if item == "weapon_upgrade" : util.rpg.item_use.weapon(interaction)
                if item == "armor_upgrade": util.rpg.item_use.armor(interaction)
                if item == "health_potion": util.rpg.item_use.health_potion(interaction)
                if item == "mana_potion": util.rpg.item_use.mana_potion(interaction)
